...
const HotelDetail = () => {
    ...
    const createCustomIcon = (text, type) => {
        ...
        return L.divIcon({
            ...
            html: `<div style="background-color: <span class="math-inline">\{iconColor\}; color\: white; padding\: 5px; border\-radius\: 50%; text\-align\: center; font\-size\: 12px;"\></span>{text}</div>`,
            iconSize: [30, 30],
            iconAnchor: [15, 15],
        });
    };
    ...
    return (
        <Box sx={{ bgcolor: '#393E46', color: '#EEEEEE', minHeight: '100vh' }}>
            ...
            <Paper sx={{ p: 3, bgcolor: '#FFFFFF', borderRadius: 2, boxShadow: 3, maxWidth: 800, mx: 'auto', mt: -10, position: 'relative', zIndex: 2 }}><Grid container spacing={3}>
                    <Grid item xs={12}>
